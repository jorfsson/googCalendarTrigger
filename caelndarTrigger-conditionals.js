...
Logger.log(eventStartMin);

  if ((todayHr == eventStartHr) && ((Math.abs(todayMin - eventStartMin) <= 7)) && (Math.abs(todayMin - eventStartMin) >= -5)) {
    lagProduct();
  } else {
    Logger.log("nolo wurld;");
    }
  }
}
